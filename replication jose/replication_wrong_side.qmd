...
$$
\begin{aligned}
S e g & =\alpha_1 R D I+\alpha_2 \mathbf{X}+\mu  &\text{(First Stage)} \\
Y & =\beta_1 S e g+\beta_2 \mathbf{X}+\varepsilon, &\text{(Second Stage)}
\end{aligned}
$$
...
![Figure 3 in the paper](figure 3.png)
...
![Figure 4 in the paper](figure 4.png)
